    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dispatcher", x => x.SenderId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Dispatcher_DispatcherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cargo_Dispatcher_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Dispatcher",
                        principalColumn: "SenderId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cargo_Route_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Route",
                        principalColumn: "RouteId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cargo_Vehicle_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceHistory", x => x.HistoryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_DispatcherId",
                table: "AspNetUsers",
                column: "DispatcherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cargo_VehicleId",
                table: "Cargo",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_Device_CargoId",
                table: "Device",
                column: "CargoId");
